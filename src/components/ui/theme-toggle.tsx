...
/**
 * ThemeToggle — a compact sliding-knob dark/light switch (Moon ⇄ Sun).
 * Faithful to the provided reference design; wired to the ThemeProvider so it
 * actually flips the `.dark` class on <html> and persists the choice.
 */
